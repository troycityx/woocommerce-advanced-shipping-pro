...
/**
 * Class WCASP_Match_Conditions
 *
 * The WCASP Match Conditions class handles the matching rules for Advanced Shipping
 *
 * @class 		WCASP_Match_Conditions
 * @author		Your Name
...
class WCASP_Match_Conditions {
	...
	public function __construct() {
		add_filter( 'wcasp_match_condition_zipcode', array( $this, 'wcasp_match_condition_zipcode' ), 10, 3 );
	}
	 ...
	 */
	public function wcasp_match_condition_zipcode( $match, $operator, $value ) {
